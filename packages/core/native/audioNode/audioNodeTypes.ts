...
export type AudioNodeClassName<Name extends AudioNodeName = AudioNodeName> =
  AudioNodeMetadata<Name>["constructorName"]

export type AudioNodeContextMethod<Name extends AudioNodeName = AudioNodeName> =
  AudioNodeMetadata<Name>["contextMethod"]
